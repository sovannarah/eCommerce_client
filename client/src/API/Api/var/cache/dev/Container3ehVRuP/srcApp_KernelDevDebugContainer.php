...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\EventListener\\ArticleUploadListener' => ['privates', 'App\\EventListener\\ArticleUploadListener', 'getArticleUploadListenerService.php', true],
            'doctrine.orm.default_listeners.attach_entity_listeners' => ['privates', 'doctrine.orm.default_listeners.attach_entity_listeners', 'getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php', true],
        ], [
            'App\\EventListener\\ArticleUploadListener' => '?',
            'doctrine.orm.default_listeners.attach_entity_listeners' => '?',
        ]));
        $c->addEventListener([0 => 'prePersist'], 'App\\EventListener\\ArticleUploadListener');
        $c->addEventListener([0 => 'preUpdate'], 'App\\EventListener\\ArticleUploadListener');
        $c->addEventListener([0 => 'postLoad'], 'App\\EventListener\\ArticleUploadListener');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_dff9740f39f6394ea3aeff4c40bd38c8880a7c4e6182775edc2315a972f2eace');
